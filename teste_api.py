...
def debug_gemini_25_flash():
    ...
    try:
        ...
        print("\n2️  VERIFICANDO DISPONIBILIDADE DO MODELO...")
        ...
        print("\n5️  TESTANDO GERAÇÃO DE CONTEÚDO...")
        ...
        print("\n6️  TESTANDO CONFIGURAÇÕES PERSONALIZADAS...")
        try:
            generation_config = {
                "temperature": 0.3,
                "top_p": 0.8,
            ...
            print(f"  Erro nas configurações personalizadas: {e}")
